...
module ActionCable
  ...
  # source://actioncable/8.0.0.beta1-701af3732145d5b1e598466bd73eb63b5ac21674/lib/action_cable.rb#77
  def server; end

  class << self
    # source://actioncable/8.0.0.beta1-701af3732145d5b1e598466bd73eb63b5ac21674/lib/action_cable/deprecator.rb#6
    def deprecator; end

    # source://actioncable/8.0.0.beta1-701af3732145d5b1e598466bd73eb63b5ac21674/lib/action_cable/gem_version.rb#7
    def gem_version; end

    # source://actioncable/8.0.0.beta1-701af3732145d5b1e598466bd73eb63b5ac21674/lib/action_cable.rb#77
    def server; end

    # source://actioncable/8.0.0.beta1-701af3732145d5b1e598466bd73eb63b5ac21674/lib/action_cable/version.rb#9
    def version; end
  end
end
...
class ActionCable::SubscriptionAdapter::SolidCable < ::ActionCable::SubscriptionAdapter::Base
  ...
  # source://actioncable/8.0.0.beta1-701af3732145d5b1e598466bd73eb63b5ac21674/lib/action_cable/subscription_adapter/channel_prefix.rb#8
  def broadcast(channel, payload); end

  # source://solid_cable//lib/action_cable/subscription_adapter/solid_cable.rb#31
  def shutdown(*_arg0, **_arg1, &_arg2); end

  # source://actioncable/8.0.0.beta1-701af3732145d5b1e598466bd73eb63b5ac21674/lib/action_cable/subscription_adapter/channel_prefix.rb#13
  def subscribe(channel, callback, success_callback = T.unsafe(nil)); end

  # source://actioncable/8.0.0.beta1-701af3732145d5b1e598466bd73eb63b5ac21674/lib/action_cable/subscription_adapter/channel_prefix.rb#18
