...
# @private
#
# source://rspec-support//lib/rspec/support/source.rb#10
class RSpec::Support::Source
  # :nocov:
  #
  # @return [Source] a new instance of Source
  #
  # source://rspec-support//lib/rspec/support/source.rb#29
  def initialize(source_string, path = T.unsafe(nil)); end

  # source://rspec-support//lib/rspec/support/source.rb#54
  def ast; end

  # source://rspec-support//lib/rspec/support/source.rb#46
  def inspect; end

  # source://rspec-support//lib/rspec/support/source.rb#42
  def lines; end

  # source://rspec-support//lib/rspec/support/source.rb#71
  def nodes_by_line_number; end

  # Returns the value of attribute path.
  #
  # source://rspec-support//lib/rspec/support/source.rb#11
  def path; end
  ...
  # source://rspec-support//lib/rspec/support/source.rb#63
  def tokens; end

  # source://rspec-support//lib/rspec/support/source.rb#78
  def tokens_by_line_number; end

  class << self
    # source://rspec-support//lib/rspec/support/source.rb#23
...
# @private
#
# source://rspec-support//lib/rspec/support/source/node.rb#99
class RSpec::Support::Source::ExpressionSequenceNode < ::RSpec::Support::Source::Node
  # source://rspec-support//lib/rspec/support/source/node.rb#100
  def type; end

  private

  # source://rspec-support//lib/rspec/support/source/node.rb#106
  def raw_args; end
end
...
#
# source://rspec-support//lib/rspec/support/source.rb#15
...
# @private
#
# source://rspec-support//lib/rspec/support/source/location.rb#8
class RSpec::Support::Source::Location < ::Struct
  include ::Comparable

  # source://rspec-support//lib/rspec/support/source/location.rb#15
  def <=>(other); end
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://rspec-support//lib/rspec/support/source/location.rb#11
    def location?(array); end
...
# @private
#
# source://rspec-support//lib/rspec/support/source/node.rb#10
class RSpec::Support::Source::Node
  include ::Enumerable

  # @return [Node] a new instance of Node
  #
  # source://rspec-support//lib/rspec/support/source/node.rb#19
  def initialize(ripper_sexp, parent = T.unsafe(nil)); end

  # source://rspec-support//lib/rspec/support/source/node.rb#28
  def args; end

  # source://rspec-support//lib/rspec/support/source/node.rb#42
  def children; end

  # We use a loop here (instead of recursion) to prevent SystemStackError
  #
  # source://rspec-support//lib/rspec/support/source/node.rb#51
  def each; end

  # source://rspec-support//lib/rspec/support/source/node.rb#63
  def each_ancestor; end

  # source://rspec-support//lib/rspec/support/source/node.rb#73
  def inspect; end

  # source://rspec-support//lib/rspec/support/source/node.rb#46
  def location; end

  # Returns the value of attribute parent.
  #
  # source://rspec-support//lib/rspec/support/source/node.rb#13
  def parent; end
  ...
  # source://rspec-support//lib/rspec/support/source/node.rb#24
  def type; end

  private

  # source://rspec-support//lib/rspec/support/source/node.rb#79
  def raw_args; end

  class << self
    # @return [Boolean]
    #
    # source://rspec-support//lib/rspec/support/source/node.rb#15
    def sexp?(array); end
  end
end
...
# @private
#
# source://rspec-support//lib/rspec/support/source/token.rb#10
class RSpec::Support::Source::Token
  # @return [Token] a new instance of Token
  #
  # source://rspec-support//lib/rspec/support/source/token.rb#29
  def initialize(ripper_token); end

  # source://rspec-support//lib/rspec/support/source/token.rb#45
  def ==(other); end

  # @return [Boolean]
  #
  # source://rspec-support//lib/rspec/support/source/token.rb#67
  ...
  # @return [Boolean]
  #
  # source://rspec-support//lib/rspec/support/source/token.rb#59
  def equals_operator?; end

  # source://rspec-support//lib/rspec/support/source/token.rb#51
  def inspect; end

  # @return [Boolean]
  #
  # source://rspec-support//lib/rspec/support/source/token.rb#55
  def keyword?; end

  # source://rspec-support//lib/rspec/support/source/token.rb#33
  def location; end

  # @return [Boolean]
  #
  # source://rspec-support//lib/rspec/support/source/token.rb#63
  def opening?; end

  # source://rspec-support//lib/rspec/support/source/token.rb#41
  def string; end

  # Returns the value of attribute token.
  #
  # source://rspec-support//lib/rspec/support/source/token.rb#23
  def token; end

  # source://rspec-support//lib/rspec/support/source/token.rb#37
  def type; end
  ...
  # @return [Boolean]
  #
  # source://rspec-support//lib/rspec/support/source/token.rb#82
  def delimiter_closed_by?(other); end

  # @return [Boolean]
  #
  # source://rspec-support//lib/rspec/support/source/token.rb#86
  def keyword_closed_by?(other); end

  # @return [Boolean]
  #
  # source://rspec-support//lib/rspec/support/source/token.rb#73
  def opening_delimiter?; end

  # @return [Boolean]
  #
  # source://rspec-support//lib/rspec/support/source/token.rb#77
  def opening_keyword?; end

  class << self
    # source://rspec-support//lib/rspec/support/source/token.rb#25
    def tokens_from_ripper_tokens(ripper_tokens); end
  end
end

# source://rspec-support//lib/rspec/support/source/token.rb#18
RSpec::Support::Source::Token::CLOSING_KEYWORDS_BY_OPENING_KEYWORD = T.let(T.unsafe(nil), Hash)

# source://rspec-support//lib/rspec/support/source/token.rb#11
RSpec::Support::Source::Token::CLOSING_TYPES_BY_OPENING_TYPE = T.let(T.unsafe(nil), Hash)
