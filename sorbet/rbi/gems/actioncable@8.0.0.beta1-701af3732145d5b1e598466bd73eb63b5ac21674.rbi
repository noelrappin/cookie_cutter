...
class ActionCable::SubscriptionAdapter::SolidCable < ::ActionCable::SubscriptionAdapter::Base
  # source://solid_cable/3.0.2/lib/action_cable/subscription_adapter/solid_cable.rb#12
  def initialize(*_arg0); end

  # source://actioncable//lib/action_cable/subscription_adapter/channel_prefix.rb#8
  def broadcast(channel, payload); end

  # source://solid_cable/3.0.2/lib/action_cable/subscription_adapter/solid_cable.rb#31
  ...
  # source://solid_cable/3.0.2/lib/action_cable/subscription_adapter/solid_cable.rb#34
  def listener; end
end
